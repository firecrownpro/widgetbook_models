...
class _$ChatMessageTearOff {
  ...
  _ChatMessage call({required String user, required String message}) {
    return _ChatMessage(
      user: user,
      message: message,
    );
...
class _$_ChatMessage implements _ChatMessage {
  _$_ChatMessage({required this.user, required this.message});
...
abstract class _ChatMessage implements ChatMessage {
  factory _ChatMessage({required String user, required String message}) =
      _$_ChatMessage;
